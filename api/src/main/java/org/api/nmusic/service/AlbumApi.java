...
import org.api.nmusic.model.vo.album.album.*;
import org.api.nmusic.model.vo.album.detail.Album;
import org.api.nmusic.model.vo.album.detail.AlbumDetailRes;
import org.api.nmusic.model.vo.album.detail.DescrItem;
import org.api.nmusic.model.vo.album.detail.Product;
import org.api.nmusic.model.vo.album.sublist.AlbumSubListRes;
import org.api.nmusic.model.vo.album.sublist.ArtistsItem;
import org.api.nmusic.model.vo.album.sublist.DataItem;
...
public class AlbumApi {
    ...
    public AlbumRes album(Long id) {
        ...
        org.api.nmusic.model.vo.album.album.Album album = new org.api.nmusic.model.vo.album.album.Album();
        ...
        List<ArtistConvert> singerListByAlbumIds = qukuService.getArtistByAlbumIds(id);
        ArrayList<org.api.nmusic.model.vo.album.album.ArtistsItem> artists = new ArrayList<>();
        for (ArtistConvert singerListByAlbumId : singerListByAlbumIds) {
            org.api.nmusic.model.vo.album.album.ArtistsItem e = new org.api.nmusic.model.vo.album.album.ArtistsItem();
