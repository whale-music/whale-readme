...
import org.api.nmusic.model.vo.personalfm.Album;
import org.api.nmusic.model.vo.personalfm.ArtistsItem;
import org.api.nmusic.model.vo.personalfm.DataItem;
import org.api.nmusic.model.vo.personalfm.PersonalFMRes;
import org.api.nmusic.model.vo.personalized.PersonalizedRes;
import org.api.nmusic.model.vo.personalized.ResultItem;
import org.api.nmusic.model.vo.recommend.albumnew.Artist;
import org.api.nmusic.model.vo.recommend.albumnew.RecommendAlbumNewRes;
import org.api.nmusic.model.vo.recommend.resource.Creator;
import org.api.nmusic.model.vo.recommend.resource.DailyRecommendResourceRes;
import org.api.nmusic.model.vo.recommend.songs.*;
...
public class RecommendApi {
    ...
    public RecommendSongerRes recommendSongs(int limit) {
        ...
        for (int i = 0; i < limit; i++) {
            ...
            // 歌手信息
            ArrayList<org.api.nmusic.model.vo.recommend.songs.Artist> artists = new ArrayList<>();
            ...
            for (ArtistConvert tbArtistPojo : singerByMusicId) {
                ...
                // 兼容web api
                org.api.nmusic.model.vo.recommend.songs.Artist artist = new org.api.nmusic.model.vo.recommend.songs.Artist();
    ...
    public Page<RecommendAlbumNewRes> albumNew(String area, Long offset, Long limit) {
        ...
        for (AlbumConvert albumPojo : albumPojoList.getRecords()) {
            ...
            List<org.api.nmusic.model.vo.recommend.albumnew.ArtistsItem> artists = new ArrayList<>();
            for (ArtistConvert singerListByAlbumId : singerListByAlbumIds) {
                org.api.nmusic.model.vo.recommend.albumnew.ArtistsItem artistsItem = new org.api.nmusic.model.vo.recommend.albumnew.ArtistsItem();
