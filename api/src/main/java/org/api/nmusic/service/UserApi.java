...
public class UserApi {
    ...
    public UserDetailRes userDetail(Long uid) {
        ...
        res.setMobileSign(false);
        res.setPcSign(false);
        
        res.setAdValid(false);
        res.setCode(200);
        res.setNewUser(false);
        res.setRecallUser(false);
        res.setCreateTime(accUserPojo.getCreateTimeToTime());
        res.setCreateDays(23333);
        
        UserDetailRes.UserPoint userPoint = new UserDetailRes.UserPoint();
        userPoint.setUserId(accUserPojo.getId());
        userPoint.setStatus(1);
        userPoint.setBalance(231);
        userPoint.setUpdateTime(accUserPojo.getCreateTimeToTime());
        userPoint.setVersion(0);
        userPoint.setStatus(1);
        userPoint.setBlockBalance(0);
        res.setUserPoint(userPoint);
        
        
        UserDetailRes.Profile profile = new UserDetailRes.Profile();
        UserDetailRes.Profile.PrivacyItemUnlimit privacyItemUnlimit = new UserDetailRes.Profile.PrivacyItemUnlimit();
        privacyItemUnlimit.setArea(true);
        privacyItemUnlimit.setCollege(true);
        privacyItemUnlimit.setGender(true);
        privacyItemUnlimit.setAge(true);
        privacyItemUnlimit.setVillageAge(true);
        profile.setPrivacyItemUnlimit(privacyItemUnlimit);
        profile.setAvatarDetail(null);
        profile.setAuthStatus(0);
        profile.setExpertTags(null);
        profile.setMutual(false);
        profile.setAccountStatus(0);
        profile.setVipType(11);
        profile.setDjStatus(10);
        profile.setAvatarImgId(109951169295086670L);
        profile.setProvince(440000);
        profile.setCity(440300);
        profile.setGender(0);
        profile.setFollowed(false);
        profile.setAvatarUrl(remoteStorePicService.getUserAvatarPicUrl(accUserPojo.getId()));
        profile.setBackgroundImgId(null);
        profile.setBackgroundUrl(remoteStorePicService.getUserBackgroundPicUrl(accUserPojo.getId()));
        profile.setRemarkName(null);
        profile.setUserType(0);
        profile.setCreateTime(accUserPojo.getCreateTimeToTime());
        profile.setAvatarImgIdStr("");
        profile.setBirthday(0L);
        profile.setNickname(accUserPojo.getNickname());
        profile.setDefaultAvatar(false);
        profile.setExperts(new UserDetailRes.Profile.Experts());
        profile.setDetailDescription("");
        profile.setBackgroundImgIdStr("");
        profile.setDescription("");
        profile.setUserId(accUserPojo.getId());
        profile.setSignature(accUserPojo.getSignature());
        profile.setAuthority(0);
        profile.setFolloweds(23333);
        profile.setFollows(23333);
        profile.setBlacklist(false);
        profile.setEventCount(23333);
        profile.setAllSubscribedCount(0);
        profile.setPlaylistBeSubscribedCount(0);
        profile.setAvatarImgId_Str("");
        profile.setFollowTime(null);
        profile.setFollowMe(false);
        profile.setArtistIdentity(new ArrayList<>());
        profile.setCCount(0);
        profile.setInBlacklist(false);
        profile.setSDJPCount(0);
        profile.setPlaylistCount(0);
        profile.setSCount(0);
        profile.setNewFollows(0);
        res.setProfile(profile);
        
        res.setBindings(new ArrayList<>());
