...
# https://github.com/whale-music/whale-music-web/releases/download/v1.0.0-beta/dist.tar.gz
WEB_URL_PATH="${MIRROR}https://github.com/whale-music/whale-music-web/releases/download/$1/dist.tar.gz"
